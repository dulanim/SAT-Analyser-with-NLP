...
public class PropertyFile {
    ...
    public static final String wordNetDbDirectory ="/usr/local/WordNet-2.1/dict" ;
    ...
    public static String docsFilePath = System.getProperty("user.home")+File.separator+"SATAnalyzer"+File.separator+"XML Files";
    public static final String imagePath = System.getProperty("user.dir")+File.separator+"img"; // img folder in
    public static String configuration_file_path = System.getProperty("user.home")+File.separator + "sat_configuration.xml";
    // project
